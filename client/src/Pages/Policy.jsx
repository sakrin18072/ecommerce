  ...
  return (
    <Layout>
        <div className="d-flex flex-column flex-sm-row justify-content-center align-items-center" style={{minHeight:'70vh'}}>
          <div >
              <img className='m-4' style={{height:'40vh',maxWidth:'60vw',borderRadius:'25px'}} src="https://as2.ftcdn.net/v2/jpg/03/76/72/01/1000_F_376720115_oU89yXDU3UW1w5jaTrQM97Sqa8VjNH91.jpg" />
          </div>
          <div className="w-100">
